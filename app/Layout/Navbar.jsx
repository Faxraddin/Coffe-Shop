    ...
    <header className="w-full h-auto flex justify-center items-center">
      <div className="w-[90%] flex items-center justify-between py-5">
        <div className="flex items-center justify-center gap-3">
          <Image alt="Logo" src={'/Logo.png'} width={2000} height={2000} className="w-[50px] big:w-[5vw] sm:w-[40px] rounded-full h-auto" />
          <h1 className="text-[30px] big:text-[2vw] font-bold">Coffeo</h1>
        </div>
        ...
        <div className="lg:hidden flex big:text-[1.4vw] text-[18px] justify-center items-center gap-7">
          <Link href={'/'}>Home</Link>
          <Link href={'/About'}>About</Link>
          <Link href={'/Contact'}>Contact Us</Link>
        </div>
        <button className="lg:hidden rounded-[40px] big:p-[1vw] big:text-[1.4vw] border-gray-500 text-[16px] transition-all ease-linear duration-300 border hover:bg-white hover:border-[#723d29] hover:text-[#723d29] bg-[#723d29] p-4 text-white">Get Started Now!</button>
